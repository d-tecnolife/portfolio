...
**Active Directory User Administration Tool** <span style="float:right; font-family:monospace;">2025</span>

[github.com/d-tecnolife/aduser-admin](https://github.com/d-tecnolife/ADUserAdmin)

- GUI tool over PowerShell cmdlets (Get-ADUser, New-ADUser) to simplify AD administration for non-technical staff
- Automated user provisioning with input validation and attribute assignment
- Built with PowerShell, XAML, and WPF
